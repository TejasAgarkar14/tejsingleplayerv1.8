...
### SCENE TRANSITIONS AHEADS: College to Maze #########################
#college to maze
func _on_collegetomaze_body_entered(body):
	if body.is_in_group("player"):
		print("entered from college to maze")
		get_tree().change_scene_to_file("res://scene/maze.tscn")


#######################################################################
### SCENE TRANSITIONS AHEADS: MAZE TO CLASSROOM #########################
#######################################################################
#area ===> maze - classroom
func _on_area_body_entered(body):
	if body.is_in_group("player"):
		print("entered from maze to classroom")
		get_tree().change_scene_to_file("res://scene/classroom.tscn")

#maze2toclassroom2
func _on_maze_2_toclassroom_2_body_entered(body):
	if body.is_in_group("player"):
		print("entered from maze2 to classroom2")
		get_tree().change_scene_to_file("res://scene/classroom_2.tscn")
		

#maze3toclassroom3
func _on_maze_3_toclassroom_3_body_entered(body):
	if body.is_in_group("player"):
		print("entered from maze3 to classroom3")
		get_tree().change_scene_to_file("res://scene/classroom_3.tscn")
		



#######################################################################
########### SCENE TRANSITIONS AHEADS: MAZE TO MAZE ####################
#######################################################################
#maze to maze2
func _on_mazetomaze_2_body_entered(body):
	if body.is_in_group("player"):
		print("entered from maze to maze2")
		get_tree().change_scene_to_file("res://scene/maze_2.tscn")

#maze2 to maze3
func _on_maze_2_tomaze_3_body_entered(body):
	if body.is_in_group("player"):
		print("entered from maze2 to maze3")
		get_tree().change_scene_to_file("res://scene/maze_3.tscn")

#maze3 to maze
func _on_maze_3_tomaze_body_entered(body):
	if body.is_in_group("player"):
		print("entered from maze to maze3")
		get_tree().change_scene_to_file("res://scene/maze.tscn")


#######################################################################
########### SCENE TRANSITIONS AHEADS: CLASSROOM TO MAZE ###############
#######################################################################

#classroom to maze
func _on_classroomtomaze_body_entered(body):
	if body.is_in_group("player"):
		print("entered from classroom to maze")
		get_tree().change_scene_to_file("res://scene/maze.tscn")


#classroom2 to maze2
func _on_classroom_2_tomaze_2_body_entered(body):
	if body.is_in_group("player"):
		print("entered from classroom to maze")
		get_tree().change_scene_to_file("res://scene/maze_2.tscn")

#classroom2 to maze2
func _on_classroom_3_tomaze_3_body_entered(body):
	if body.is_in_group("player"):
		print("entered from classroom to maze")
		get_tree().change_scene_to_file("res://scene/maze_3.tscn")
